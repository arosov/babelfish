...
class TestEngine(unittest.TestCase):
    ...
    def test_engine_initialization(self, mock_config, mock_transcriber):
        ...
        # Verify transcriber created with config
        mock_transcriber.assert_called_once_with(config=mock_config_instance)
    ...
    def test_transcribe_stream(self, mock_config, mock_transcriber):
        ...
        mock_transcriber.return_value.stream.assert_called_once_with(mock_audio)
